...
# password as sha1:<salt>:<hash> (to be built appropriately from environment variable):
# noinspection PyUnresolvedReferences
...
c.JupyterLabTemplates.template_dirs = ['/app/notebooks/analytics_tests/templates']
